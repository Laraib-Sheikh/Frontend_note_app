  ...
  return(
    <div className='border border-green-200 bg-white p-4 rounded hover:shadow-2xl transition-shadow duration-500'>
        <div className="flex items-center justify-between">
            ...
            <MdOutlinePushPin className={`icon-btn ${isPinned ? 'text-blue-400' : 'text-slate-500'}`} onClick={onPinNote}/>
        </div>
        ...
        <div className='flex items-center justify-between mt-2'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <MdDelete className='icon-btn hover:text-green-500' onClick={onDelete}/>
